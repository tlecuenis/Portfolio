import "./home.css"
import CV from "../assets/CV-Software.pdf"
    ...
    return(
        <div className='home-container'>
            ...
            <div className='home-container__phrase'>
                ...
                <p className="home-container__role medium-introduce">Software Developer</p>
                ...
                <div className="home-container__buttons">
                    ...
                    <a href={CV} download="CV-Software.pdf"><button className='home-container__button cv' title="Download CV">CV</button></a>
                </div>
            </div>
        </div>    
    )
